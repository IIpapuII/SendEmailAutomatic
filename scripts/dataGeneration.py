...
class Proveedores:
    ...
    def triggersQuery(self):
        cursor = coon.cursor()
        querySQL = open(os.path.join(os.getcwd(),'DesarrolloParaGelvez/SendEmailAutomatic/scripts/query/Iventory.sql'))
    ...
    def transformData(self):
        ...
        wb.save(os.path.join(os.getcwd(),'DesarrolloParaGelvez/SendEmailAutomatic/docs/'+self.nameArchivo()))
